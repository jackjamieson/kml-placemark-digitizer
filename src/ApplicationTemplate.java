 ...
 * how it's used.
 * 
 * NOTE TO GCHERMAN: You do not need to edit this file.  It is just a base for setting up World Wind.
 *
...
public class ApplicationTemplate
{
    public static class AppPanel extends JPanel
    {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 841695500239683522L;
    ...
    protected static class AppFrame extends JFrame
    {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 1370145455559868310L;

		private Dimension canvasSize = new Dimension(1000, 700);
    ...
    public static void main(String[] args)
    {
        ...
        ApplicationTemplate.start("World Wind 3 Point Problem Solver", AppFrame.class);
    }
}
